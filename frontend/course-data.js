        ...
        },
        {
          ...
          sections: [
            ...
            // ========== FOR CLASSICO (OPCIONAL - so se precisar) ==========
            {
              ...
              content: "<div style='background:#3a2a1a;border-left:3px solid #f48771;padding:10px;border-radius:4px;margin-bottom:15px'>⚠️ <strong>PULA ESSA PARTE!</strong> O for...of ja resolve 99% dos casos. So volte aqui se PRECISAR de um contador numerico tipo \"mostre os numeros de 1 ate 10\".</div>O <strong>for classico</strong> serve pra quando voce quer um <strong>contador</strong> — tipo contar de 1 ate 10.<br><br>Exemplo:<br><pre style='background:#1e1e1e;padding:15px;border-radius:8px;font-size:14px;line-height:1.8'><span style='color:#c586c0'>for</span> (<span style='color:#c586c0'>let</span> <span style='color:#9cdcfe'>i</span> = <span style='color:#b5cea8'>1</span>; <span style='color:#9cdcfe'>i</span> <= <span style='color:#b5cea8'>5</span>; <span style='color:#9cdcfe'>i</span>++) {\n  <span style='color:#dcdcaa'>console</span>.<span style='color:#dcdcaa'>log</span>(<span style='color:#ce9178'>\"Numero:\"</span>, <span style='color:#9cdcfe'>i</span>)\n}</pre><br>Traduz pra portugues:<br><br>📌 <code>let i = 1</code> → começa com i valendo 1<br>📌 <code>i <= 5</code> → continua enquanto i for menor ou igual a 5<br>📌 <code>i++</code> → a cada rodada, soma 1 no i<br><br>Saida: mostra 1, 2, 3, 4, 5 e para.<br><br><div style='background:#1a3a2a;border-left:3px solid #4caf50;padding:10px;border-radius:4px'>💡 O nome <code>i</code> e uma convencao (tradicao). Pode usar outro nome, mas todo mundo usa <code>i</code> (de \"indice\"). Nao e obrigatorio, mas todo programador entende.</div>"
            },
            {
              type: "explanation",
              title: "Por que tem 3 partes? Vamos por partes...",
              content: "O for classico parece confuso, mas e so <strong>3 comandos numa linha</strong>. Olha o que ta acontecendo:<br><br><strong>Versao separada (o que ta acontecendo por dentro):</strong><br><pre style='background:#1e1e1e;padding:15px;border-radius:8px;font-size:14px;line-height:1.8'><span style='color:#c586c0'>let</span> <span style='color:#9cdcfe'>i</span> = <span style='color:#b5cea8'>1</span>  <span style='color:#6a9955'>// 1. Cria o contador (so roda UMA vez no inicio)</span>\n\n<span style='color:#c586c0'>while</span> (<span style='color:#9cdcfe'>i</span> <= <span style='color:#b5cea8'>5</span>) {  <span style='color:#6a9955'>// 2. Continua enquanto i <= 5</span>\n  <span style='color:#dcdcaa'>console</span>.<span style='color:#dcdcaa'>log</span>(<span style='color:#9cdcfe'>i</span>)\n  <span style='color:#9cdcfe'>i</span>++  <span style='color:#6a9955'>// 3. Soma 1 no final de cada rodada</span>\n}</pre><br><strong>Versao for (tudo numa linha):</strong><br><pre style='background:#1e1e1e;padding:15px;border-radius:8px;font-size:14px;line-height:1.8'><span style='color:#c586c0'>for</span> (<span style='color:#c586c0'>let</span> <span style='color:#9cdcfe'>i</span> = <span style='color:#b5cea8'>1</span>; <span style='color:#9cdcfe'>i</span> <= <span style='color:#b5cea8'>5</span>; <span style='color:#9cdcfe'>i</span>++) {\n  <span style='color:#dcdcaa'>console</span>.<span style='color:#dcdcaa'>log</span>(<span style='color:#9cdcfe'>i</span>)\n}</pre><br>E a MESMA coisa! O for so junta os 3 comandos numa linha pra economizar espaco.<br><br><div style='background:#1a2a3a;border-left:3px solid #4fc3f7;padding:10px;border-radius:4px'>Se voce nao entender o for classico, <strong>TUDO BEM!</strong> Use <strong>for...of</strong> sempre. Ele resolve 99% dos problemas e e muito mais facil.</div>"
            },
            {
              type: "explanation",
